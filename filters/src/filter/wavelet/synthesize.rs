...
impl<'a, T, N> ConfigTrait for &'a Synthesize<T, N>
where
    N: ArrayLength<T>,
{
...
impl<T, N> Stateful for Synthesize<T, N>
where
    N: ArrayLength<T>,
{
...
unsafe impl<T, N> StatefulUnsafe for Synthesize<T, N>
where
    N: ArrayLength<T>,
{
...
impl<'a, T, N> InitialState<&'a Config<T, N>> for Synthesize<T, N>
where
    T: Clone,
    N: ArrayLength<T>,
    ConvolveConfig<T, N>: Clone,
...
impl<T, N> Resettable for Synthesize<T, N>
where
    T: Clone,
    N: ArrayLength<T>,
    ConvolveConfig<T, N>: Clone,
