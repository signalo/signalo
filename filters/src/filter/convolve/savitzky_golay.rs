...
savitzky_golay_impl_float!(6 => [
    -0.19048, -0.04762, 0.09524, 0.2381, 0.38095, 0.52381
]);
savitzky_golay_impl_float!(7 => [
    -0.17857, -0.07143, 0.03571, 0.14286, 0.25, 0.35714, 0.46429
]);
savitzky_golay_impl_float!(8 => [
    -0.16667, -0.08333, 0.0, 0.08333, 0.16667, 0.25, 0.33333,
    0.41667
]);
savitzky_golay_impl_float!(9 => [
    -0.15556, -0.08889, -0.02222, 0.04444, 0.11111, 0.17778,
    0.24444, 0.31111, 0.37778
]);
savitzky_golay_impl_float!(10 => [
    -0.14545, -0.09091, -0.03636, 0.01818, 0.07273, 0.12727,
    0.18182, 0.23636, 0.29091, 0.34545
]);
savitzky_golay_impl_float!(11 => [
    -0.13636, -0.09091, -0.04545, 0.0, 0.04545, 0.09091, 0.13636,
    0.18182, 0.22727, 0.27273, 0.31818
]);
savitzky_golay_impl_float!(12 => [
    -0.12821, -0.08974, -0.05128, -0.01282, 0.02564, 0.06410,
    0.10256, 0.14103, 0.17949, 0.21795, 0.25641, 0.29487
]);
savitzky_golay_impl_float!(13 => [
    -0.12088, -0.08791, -0.05495, -0.02198, 0.01099, 0.04396,
    0.07692, 0.10989, 0.14286, 0.17582, 0.20879, 0.24176, 0.27473
]);
...
mod tests {
    ...
    fn get_output_3() -> Vec<f32> {
        vec![
            ...
            9.16654, 10.499869, 11.166571, 8.16656, 15.66655, 18.33319, 6.16654, 8.49989,
            19.99988, 21.33316, 9.16651, 4.83322, 13.66657, 16.33321, 10.8331995, 19.99984,
            14.33319, 91.99952, 185.33232, 131.49866, 20.998981, 76.33256, 36.49957, 5.666212,
            18.66652, 10.83316, 19.66651, 22.333149, 20.99979, 31.83308, 14.49979, 87.83283,
            41.666252, 8.666179, 21.666489, 13.83313, 15.99984, 89.33288, 41.16623, 6.3328705,
            26.16647
        ]
    }
    ...
    fn get_output_4() -> Vec<f32> {
        vec![
            0.0, 0.7, 5.3, 4.2999997, 4.8, 6.4, 14.5, 15.299999, 18.5, 9.9, 11.5, 8.7, 10.1,
            13.6, 17.8, 9.5, 8.299999, 15.8, 22.4, 12.5, 5.7, 10.0, 15.8, 13.1, 18.6, 14.2,
            82.0, 166.8, 156.7, 51.6, 56.199997, 26.1, 27.199999, -1.2000008, 15.9, 16.0,
            21.8, 22.6, 30.099998, 17.1, 78.7, 43.2, 32.8, 1.7999983, 18.9, 13.4, 77.6,
            47.700005, 28.4, 6.699999
        ]
    }
    ...
    fn get_output_5() -> Vec<f32> {
        vec![
            ...
            11.400001, 9.6, 8.0, 14.400002, 16.0, 10.800001, 10.400001, 14.2, 19.0, 15.4, 8.6,
            9.2, 12.4, 13.6, 19.4, 14.2, 72.200005, 152.40001, 154.4, 88.0, 70.200005, 13.0,
            17.2, 15.6, -2.999999, 19.400002, 18.400002, 22.600002, 30.400002, 18.400002,
            71.200005, 45.8, 35.600002, 21.2, 0.0, 17.6, 66.200005, 48.200005, 36.4, 23.0
        ]
    }

    fn get_output_6() -> Vec<f32> {
        vec![
            0.0, 0.52381, 4.0476203, 3.9523702, 5.14289, 7.1904902, 12.285721, 13.85713,
            18.8572, 13.666691, 13.095301, 9.619011, 8.66666, 11.904741, 16.57142, 10.380949,
            11.333401, 15.095221, 17.28566, 13.7619095, 11.6667595, 10.857141, 11.14278,
            11.04759, 19.19053, 15.76189, 64.809616, 137.80937, 149.52393, 99.143585, 98.04835,
            27.856586, 3.0473738, 6.5711718, 9.95232, 1.0949221, 21.14286, 19.666641, 29.714333,
            20.66666, 65.238235, 45.85689, 39.333748, 24.857191, 15.42856, -0.095560074,
            63.00006, 44.42831, 39.238533, 30.428703
        ]
    }
    ...
    fn get_output_10() -> Vec<f32> {
        vec![
            0.0, 0.34545, 2.7090602, 2.9636302, 4.14541, 6.0908804, 10.363541, 12.727221,
            16.45441, 14.6545315, 15.290781, 13.63639, 12.74537, 13.5091, 14.05448, 10.054629,
            10.63632, 13.600031, 17.38174, 14.018209, 12.199981, 12.527281, 12.527261, 12.07277,
            16.490831, 13.490951, 46.65407, 99.853935, 119.45385, 100.56329, 111.47197, 83.69105,
            63.708683, 37.63692, 14.0000305, -8.926382, -12.254108, 3.1280322, 17.27251, 8.47321,
            52.70854, 41.69112, 41.96318, 34.98209, 27.836031, 22.127672, 47.09026, 35.40058,
            31.34492, 22.636992
        ]
    }
    ...
    fn get_output_12() -> Vec<f32> {
        vec![
            ...
            54.486526, 36.78211, 20.67921, 6.3210998, -10.128019, -6.3337803, 4.2562094,
            39.243767, 29.40982, 40.82071, 34.5257, 31.30809, 26.30736, 47.14074, 38.3845,
            33.8463, 29.192587
        ]
    }
