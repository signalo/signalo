...
macro_rules! savitzky_golay_impl_float {
    ($width:expr => [$($num:literal / $den:literal),* $(,)?]) => {
        ...
        impl SavitzkyGolay for Convolve<f64, $width> {
            fn savitzky_golay() -> Self {
                Self::with_config(Config {
                    coefficients: [$($num as f64 / $den as f64),*]
                })
            }
        }
    };
...
mod tests {
    ...
    fn get_output_4() -> Vec<f32> {
        vec![
            0.0, 0.7, 5.3, 4.3, 4.8, 6.4, 14.5, 15.3, 18.5, 9.9, 11.5, 8.7, 10.1, 13.6,
            17.8, 9.5, 8.3, 15.8, 22.4, 12.5, 5.7, 10.0, 15.8, 13.1, 18.6, 14.2, 82.0, 166.8,
            156.7, 51.6, 56.2, 26.1, 27.2, -1.2, 15.9, 16.0, 21.8, 22.6, 30.1,
            17.1, 78.7, 43.2, 32.8, 1.8, 18.9, 13.4, 77.6, 47.7, 28.4, 6.7,
        ]
    }

    fn get_output_5() -> Vec<f32> {
        vec![
            0.0, 0.6, 4.6, 4.2, 5.2, 7.0, 12.4, 15.4, 18.8, 12.2,
            11.4, 9.6, 8.0, 14.4, 16.0, 10.8, 10.4, 14.2, 19.0, 15.4, 8.6, 9.2,
            12.4, 13.6, 19.4, 14.2, 72.2, 152.4, 154.4, 88.0, 70.2, 13.0, 17.2, 15.6,
            -3.0, 19.4, 18.4, 22.6, 30.4, 18.4, 71.2, 45.8,
            35.6, 21.2, 0.0, 17.6, 66.2, 48.2, 36.4, 23.0,
        ]
    }
    ...
    fn get_output_7() -> Vec<f32> {
        vec![
            ...
            15.35714, 17.78571, 13.0, 10.71429, 13.21429, 12.21429, 10.0, 16.32143,
            16.28571, 60.5, 125.6071, 141.0357, 104.7143, 107.5, 56.82143, 14.10714,
            -7.5, 1.107143, 10.75, 4.0, 22.07143, 26.42857, 21.60714, 61.89286,
            45.0, 40.67857, 29.46429, 18.78571, 12.35714, 41.28571, 45.60714, 37.60714,
            33.89286,
        ]
    }
    ...
    fn get_output_8() -> Vec<f32> {
        vec![
            0.0, 0.4166667, 3.25, 3.416667, 4.666667, 6.75, 11.5, 13.66667, 17.25,
            14.08333, 15.33333, 12.66667, 10.16667, 11.41667, 13.91667, 10.16667, 12.0,
            14.5, 17.83333, 14.0, 10.33333, 12.16667, 14.16667, 11.0, 14.75,
            14.16667, 56.5, 116.75, 132.5833, 104.5, 112.8333, 70.25, 40.08333,
            1.0, -13.08333, 1.583333, 11.5, 6.166667, 28.0, 19.75, 58.58333,
            45.16667, 40.91667, 31.91667, 23.33333, 15.16667, 47.33333, 28.41667, 39.91667,
            33.25,
        ]
    }
    ...
    fn get_output_9() -> Vec<f32> {
        vec![
            ...
            14.48889, 14.86667, 13.82222, 11.53333, 12.46667, 13.26667, 10.33333, 10.55556,
            15.2, 16.88889, 14.51111, 11.48889, 11.62222, 13.13333, 12.88889, 15.13333,
            12.97778, 50.88889, 108.8, 125.9556, 102.3778, 113.0889, 79.57778, 53.55556,
            24.44444, -6.888889, -12.95556, 2.311111, 12.17778, 12.75556, 22.0, 53.48889,
            44.55556, 41.86667, 33.2, 26.11111, 19.35556, 46.17778, 35.22222, 24.93333,
            36.02222,
        ]
    }
    ...
    fn get_output_10() -> Vec<f32> {
        vec![
            ...
            14.65455, 15.29091, 13.63636, 12.74545, 13.50909, 14.05455, 10.05455, 10.63636,
            13.6, 17.38182, 14.01818, 12.2, 12.52727, 12.52727, 12.07273, 16.49091,
            13.49091, 46.65455, 99.85455, 119.4545, 100.5636, 111.4727, 83.69091, 63.70909,
            37.63636, 14.0, -8.927273, -12.25455, 3.127273, 17.27273, 8.472727, 52.70909,
            41.69091, 41.96364, 34.98182, 27.83636, 22.12727, 47.09091, 35.4, 31.34545,
            22.63636,
        ]
    }
    ...
    fn get_output_11() -> Vec<f32> {
        vec![
            ...
            14.54545, 15.5, 14.22727, 12.72727, 14.5, 14.90909, 11.04545, 10.31818,
            13.40909, 15.77273, 14.77273, 11.95455, 13.09091, 13.27273, 11.59091, 15.45455,
            14.90909, 44.45455, 92.54545, 111.5455, 97.90909, 110.0, 85.45455, 69.13636,
            48.18182, 26.40909, 9.409091, -9.863636, -11.27273, 8.090909, 12.72727, 37.68182,
            42.36364, 39.81818, 35.86364, 30.0, 24.0, 47.31818, 37.27273, 31.81818,
            28.59091,
        ]
    }
    ...
    fn get_output_13() -> Vec<f32> {
        vec![
            ...
            31.49451, 28.94505, 36.0, 30.48352, 27.83516, 47.69231, 39.0, 35.17582,
            31.25275,
        ]
    }
    ...
    fn coefficients_match_scipy_reference_n7() {
        ...
        let expected: [f32; 7] = [
            0.46428571, 0.35714286, 0.25, 0.14285714, 0.03571429, -0.07142857, -0.17857143,
        ];
    ...
    fn coefficients_match_scipy_reference_n9() {
        ...
        let expected: [f32; 9] = [
            0.37777778, 0.31111111, 0.24444444, 0.17777778, 0.11111111, 0.04444444, -0.02222222,
            -0.08888889, -0.15555556,
        ];
