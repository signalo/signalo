...
fn get_output_4() -> Vec<f32> {
    vec![
        0.0, 0.7, 5.3, 4.3, 4.8, 6.4, 14.5, 15.3, 18.5, 9.9, 11.5, 8.7, 10.1, 13.6, 17.8, 9.5, 8.3,
        15.8, 22.4, 12.5, 5.7, 10.0, 15.8, 13.1, 18.6, 14.2, 82.0, 166.8, 156.7, 51.6, 56.2, 26.1,
        27.2, -1.2, 15.9, 16.0, 21.8, 22.6, 30.1, 17.1, 78.7, 43.2, 32.8, 1.8, 18.9, 13.4, 77.6,
        47.7, 28.4, 6.7,
    ]
}
...
fn get_output_5() -> Vec<f32> {
    vec![
        ...
        10.4, 14.2, 19.0, 15.4, 8.6, 9.2, 12.4, 13.6, 19.4, 14.2, 72.2, 152.4, 154.4, 88.0, 70.2,
        13.0, 17.2, 15.6, -3.0, 19.4, 18.4, 22.6, 30.4, 18.4, 71.2, 45.8, 35.6, 21.2, 0.0, 17.6,
        66.2, 48.2, 36.4, 23.0,
    ]
}
...
fn get_output_6() -> Vec<f32> {
    vec![
        ...
        13.66667, 13.09524, 9.619048, 8.666667, 11.90476, 16.57143, 10.38095, 11.33333, 15.09524,
        17.28571, 13.7619, 11.66667, 10.85714, 11.14286, 11.04762, 19.19048, 15.7619, 64.80952,
        137.8095, 149.5238, 99.14286, 98.04762, 27.85714, 3.047619, 6.571429, 9.952381, 1.095238,
        21.14286, 19.66667, 29.71429, 20.66667, 65.2381, 45.85714, 39.33333, 24.85714, 15.42857,
        -0.0952381, 63.0, 44.42857, 39.2381, 30.42857,
    ]
}

fn get_output_7() -> Vec<f32> {
    vec![
        0.0, 0.4642857, 3.607143, 3.678571, 4.928571, 7.035714, 12.0, 13.85714, 17.39286, 14.67857,
        14.35714, 11.28571, 8.642857, 11.89286, 14.17857, 11.71429, 10.85714, 15.35714, 17.78571,
        13.0, 10.71429, 13.21429, 12.21429, 10.0, 16.32143, 16.28571, 60.5, 125.6071, 141.0357,
        104.7143, 107.5, 56.82143, 14.10714, -7.5, 1.107143, 10.75, 4.0, 22.07143, 26.42857,
        21.60714, 61.89286, 45.0, 40.67857, 29.46429, 18.78571, 12.35714, 41.28571, 45.60714,
        37.60714, 33.89286,
    ]
}
...
fn get_output_8() -> Vec<f32> {
    vec![
        0.0, 0.4166667, 3.25, 3.416667, 4.666667, 6.75, 11.5, 13.66667, 17.25, 14.08333, 15.33333,
        12.66667, 10.16667, 11.41667, 13.91667, 10.16667, 12.0, 14.5, 17.83333, 14.0, 10.33333,
        12.16667, 14.16667, 11.0, 14.75, 14.16667, 56.5, 116.75, 132.5833, 104.5, 112.8333, 70.25,
        40.08333, 1.0, -13.08333, 1.583333, 11.5, 6.166667, 28.0, 19.75, 58.58333, 45.16667,
        40.91667, 31.91667, 23.33333, 15.16667, 47.33333, 28.41667, 39.91667, 33.25,
    ]
}

fn get_output_9() -> Vec<f32> {
    vec![
        0.0, 0.3777778, 2.955556, 3.177778, 4.4, 6.422222, 10.93333, 13.24444, 16.95556, 14.48889,
        14.86667, 13.82222, 11.53333, 12.46667, 13.26667, 10.33333, 10.55556, 15.2, 16.88889,
        14.51111, 11.48889, 11.62222, 13.13333, 12.88889, 15.13333, 12.97778, 50.88889, 108.8,
        125.9556, 102.3778, 113.0889, 79.57778, 53.55556, 24.44444, -6.888889, -12.95556, 2.311111,
        12.17778, 12.75556, 22.0, 53.48889, 44.55556, 41.86667, 33.2, 26.11111, 19.35556, 46.17778,
        35.22222, 24.93333, 36.02222,
    ]
}
...
fn get_output_10() -> Vec<f32> {
    vec![
        ...
        -12.25455, 3.127273, 17.27273, 8.472727, 52.70909, 41.69091, 41.96364, 34.98182, 27.83636,
        22.12727, 47.09091, 35.4, 31.34545, 22.63636,
    ]
}

fn get_output_11() -> Vec<f32> {
    vec![
        0.0, 0.3181818, 2.5, 2.772727, 3.909091, 5.772727, 9.818182, 12.18182, 15.86364, 14.54545,
        15.5, 14.22727, 12.72727, 14.5, 14.90909, 11.04545, 10.31818, 13.40909, 15.77273, 14.77273,
        11.95455, 13.09091, 13.27273, 11.59091, 15.45455, 14.90909, 44.45455, 92.54545, 111.5455,
        97.90909, 110.0, 85.45455, 69.13636, 48.18182, 26.40909, 9.409091, -9.863636, -11.27273,
        8.090909, 12.72727, 37.68182, 42.36364, 39.81818, 35.86364, 30.0, 24.0, 47.31818, 37.27273,
        31.81818, 28.59091,
    ]
}
...
fn get_output_12() -> Vec<f32> {
    vec![
        ...
        14.28205, 15.44872, 14.60256, 13.41026, 14.39744, 15.76923, 12.08974, 11.19231, 12.88462,
        15.44872, 13.52564, 12.83333, 12.79487, 13.74359, 12.34615, 14.74359, 14.10256, 43.51282,
        87.48718, 104.7949, 93.20513, 107.641, 86.82051, 72.26923, 54.48718, 36.78205, 20.67949,
        6.320513, -10.12821, -6.333333, 4.25641, 39.24359, 29.41026, 40.82051, 34.52564, 31.30769,
        26.30769, 47.14103, 38.38462, 33.84615, 29.19231,
    ]
}
...
fn get_output_13() -> Vec<f32> {
    vec![
        ...
        13.93407, 15.24176, 14.71429, 13.89011, 14.96703, 15.63736, 13.13187, 12.15385, 13.50549,
        14.82418, 13.40659, 11.82418, 13.56044, 13.42857, 12.85714, 15.21978, 13.54945, 40.82418,
        83.95604, 99.93407, 88.98901, 103.2527, 86.93407, 74.87912, 58.62637, 43.40659, 30.45055,
        16.52747, 4.241758, -6.406593, -9.450549, 29.26374, 31.49451, 28.94505, 36.0, 30.48352,
        27.83516, 47.69231, 39.0, 35.17582, 31.25275,
    ]
}
